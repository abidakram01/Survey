 ...
 */
export declare type JSONSchema = (JSONSchemaConst | JSONSchemaEnum | JSONSchemaBoolean | JSONSchemaNull | JSONSchemaString | JSONSchemaNumeric | JSONSchemaArray | JSONSchemaObject) & {
    [k: string]: any;
};
